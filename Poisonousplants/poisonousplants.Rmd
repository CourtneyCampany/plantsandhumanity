...
<IMG STYLE="position:absolute; TOP:160px; LEFT:20px; WIDTH:300px; HEIGHT:500px" SRC="images/cats.png">
...
* **Traditionally used in the arrow poison known as curare and was later isolated for use as a neuromuscular blocking agent in surgery**
    + Is one of the main active ingredients in the arrow poison curare, which is used for hunting

<br/>

<div style="float: lefy; width: 50%;"

* **After being isolated in the mid-1900s, tubocurarine was used clinically as a muscle relaxant during anesthesia**         + now replaced by safer synthetic alternatives.
...
## Poisonous Plants Around Home, Pets, and Campus
<hr>
...
* **Poison/Toxin: chemical substance that is harmful when ingested**
    + directly damages cells/organs, not an immune response
    + anyone can be affected above a threshold dose
