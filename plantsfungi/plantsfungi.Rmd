...
<IMG STYLE="position:absolute; TOP:200px; LEFT:25px; WIDTH:300px; HEIGHT:450px" SRC="images/coalswamp.jpg">

## The current state of agriculture: Role of fungi
<hr>

* **Dramatic increases in agricultural productivity in 20^th^ century**
    + development + application of pesticides, fertilisers
    + advances in plant breeding and genetic technologies

<br/>

* **Now, crop yields have plateaued & fertilizer production unsustainable**
    + Climate change, over population, nutrient depletion, energy prices

<br/>

* **These are all sizeable challenges to global food security**
...
<IMG STYLE="position:absolute; TOP:400px; LEFT:20px; WIDTH:400px; HEIGHT:450px" SRC="images/depletion.jpg">
    
## Should we also innoculate our crops?
<hr>
...
* **Commerical innoculates add fungal spores, which are activated by root exudates**

 </div>
 
<IMG STYLE="position:absolute; TOP:400px; LEFT:650px; WIDTH:300px; HEIGHT:450px" SRC="images/innoculate.png">
    
## Role of mycorrhizae in agrosystems: Stress, Disease & Soil Health
<hr>

* **The use of pesticides does not aid in a plant's natural immune response**

* **Fungi colonising roots physically exclude and protect from pathogens**
...
* **Fungal hypae release polysaccrides that bind soil particles**
    ...
    + improves soil organic matter & microbial biodiversity**

## Crop experiments (1 disease & 1 stress) 
<hr>

<IMG STYLE="position:absolute; TOP:400px; LEFT:550px; WIDTH:400px; HEIGHT:450px" SRC="images/tomtatoinoc.jpg">
...
<IMG STYLE="position:absolute; TOP:400px; LEFT:20px; WIDTH:400px; HEIGHT:450px" SRC="images/agrisummary.jpg">
...
* **Tilling soul reduces mycorrhizal associations**
* **Broad spectrum fungicides are toxic to mycorrhizal fungi**
* **High levels of fertilizer reduces inoculation of roots**
