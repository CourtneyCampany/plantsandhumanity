...
## NEW THEORY: Locard’s Exchange Principle
<hr>
...
- **In two different marijuana seizures in California and Texas, pollen analysis revealed a unique sagebrush pollen marker**
    + sagebrush species was known to grow in only a few isolated regions of Mexico, pinpointing the area of cultivation cultivated

<br/>

- **A truck carrying cocaine was seized at the Canadian border after trying to enter from Detroit. Pollen analysis of the truck's air filter revealed the shipment originated in California and took a circuitous route across the United States instead of a direct path to Canada**

<br/>

- **Pollen analysis also has helped trace the routes of marijuana and cocaine bundles that wash up onshore along the coasts of Florida and Texas**
...
- **Comparing the types and quantities of diatoms in a victim's body with samples from potential drowning locations can establish where the drowning occurred**
...
- **Plants can cause injury or death: - Ricin from castor bean - Digitalis from foxglove - Coniine from hemlock**
    ...
    + Abraham Lincoln's mother dies from white snakeroot 
    + Juan Ponce de León died after wounding from an arrow poisoned with the manchineel tree's sap
...
- **Stable Isotope Analysis - Measuring ratios of elemental isotopes in plants reflects regional climate or water and soil composition**
    + can identify the source of illicit drugs or trace the origins of plants involved

<br/>

- **Scienitsts use strontium-87 of local soils for geological fingerprinting of poached endangered Cycads in S. Africa**
    + cycads incorporate the specific isotope signature when they absorb water/nutrients

<IMG STYLE="position:absolute; TOP:390px; LEFT:200px; WIDTH:700px; HEIGHT:290px" SRC="images/cycads.png">

## Its Time For A.........
<hr>

<IMG STYLE="position:absolute; TOP:180px; LEFT:300px; WIDTH:550px; HEIGHT:500px" SRC="images/storyquest.png">